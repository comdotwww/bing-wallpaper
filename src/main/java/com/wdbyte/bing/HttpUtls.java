...
public class HttpUtls {
    ...
    public static HttpURLConnection getHttpUrlConnection(String url) throws IOException {
        ...
        httpConnection.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.5060.114 Safari/537.36 Edg/103.0.1264.62");
